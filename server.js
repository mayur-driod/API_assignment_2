...
app.get('/status-info', (req, res) => {
    ...
    switch (code) {
        ...
        case '502':
            ...
            break;
        case '503':
            message = 'Service Unavailable: The server is currently unavailable (e.g., due to maintenance or overload).';
            break;
        case '504':
            ...
            break;
        default:
            message = 'Invalid Status Code: Please provide a valid status code.';
            break;
    }
    res.json({
        status: code,
